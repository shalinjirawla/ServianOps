...
namespace ServianOps_Backend.Application.Interfaces.Jobs
{
    public interface ITradeService
    {
        ...
        Task<ServianOps_Backend.Application.DTOs.Shared.PagedResponseDto<TradeListDto>> GetAllPagedAsync(TradeFilterDto filter);
    ...
    public interface IJobService
    {
        ...
        Task<ServianOps_Backend.Application.DTOs.Shared.PagedResponseDto<JobListDto>> GetAllPagedAsync(JobFilterDto filter);
        Task DeleteAsync(long id);
