...
{
    /// <inheritdoc />
    public partial class AddCrmModules : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountryOrState = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: false),
                    ...
                    VatNumber = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    IsPORequired = table.Column<bool>(type: "boolean", nullable: false),
                    CustomerTypeId = table.Column<long>(type: "bigint", nullable: false),
                    AccountManagerId = table.Column<long>(type: "bigint", nullable: true),
                    SellingRateId = table.Column<long>(type: "bigint", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorUserId = table.Column<long>(type: "bigint", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    LastModifierUserId = table.Column<long>(type: "bigint", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Sites_Users_AccountManagerId",
                        column: x => x.AccountManagerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerTypes_Name_TenantId",
                table: "CustomerTypes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sites_AccountManagerId",
                table: "Sites",
                column: "AccountManagerId");
